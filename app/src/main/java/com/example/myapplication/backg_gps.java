...
public class backg_gps extends AppCompatActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {


    private static final String TAG = backg_gps.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_backg_gps);
...
//        mActivityRecognitionClient = new ActivityRecognitionClient(this);
    ...
    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(backg_gps.this,
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(backg_gps.this, REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(backg_gps.this, errorMessage, Toast.LENGTH_LONG).show();
