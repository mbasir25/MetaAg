...
public class contentAdapterType extends FirebaseRecyclerAdapter<bot_row_model, contentAdapterType.myviewholder> {
    TinyDB tinyDB;
    ...
    public contentAdapterType(@NonNull FirebaseRecyclerOptions<bot_row_model> options) {
        super(options);
    }
